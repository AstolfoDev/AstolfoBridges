...
public class scoreboard {
    public Scoreboard waitBoard1(Player p) {
        ...
        Score line1 = obj.getScore(ChatColor.GRAY+"Server | "+ChatColor.DARK_GRAY+Bukkit.getServer().getMotd());
        Score line2 = obj.getScore("");
        Score line3 = obj.getScore("Players: "+ChatColor.LIGHT_PURPLE+Bukkit.getOnlinePlayers().toArray().length+"/2");
        Score line4 = obj.getScore("Map: "+ChatColor.LIGHT_PURPLE+p.getWorld().getName());
    ...
    public Scoreboard gameBoard(Document data, Player p) {
        Scoreboard sb = Bukkit.getScoreboardManager().getNewScoreboard();
        Objective obj = sb.registerNewObjective("Waitingboard1", "HIDE");
        ...
        Score line7 = obj.getScore("Map: "+ChatColor.LIGHT_PURPLE+p.getWorld().getName());
